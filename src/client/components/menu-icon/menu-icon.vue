<template>
  <svg
    ...
    <g>
      <path
        :class="{ 'menu-icon__line-center--rotated' : isOpen }"
      ...
      <path
        :class="{ 'menu-icon__line-top--rotated' : isOpen }"
        class="menu-icon__line menu-icon__line-top"
      ...
      <path
        :class="{ 'menu-icon__line-bottom--rotated' : isOpen }"
        class="menu-icon__line menu-icon__line-bottom"
